...
variable "cdh_output_s3_bucket" {
    description = "Name of AWS S3 bucket with output data"
    type = string
} 
...
variable "cdh_input2_dataset_name" {
    description = "Name of database with second source data"
    type = string
} 

variable "cdh_input2_s3_kms_key_arn" {
    description = "AWS KMS key for s3 encryption in second ingest bucket"
    type = string
} 

variable "cdh_input2_s3_bucket" {
    description = "Name of second AWS S3 bucket with ingest data"
    type = string
} 

variable "cdh_input2_glue_catalog_aws_account_id" {
    description = "AWS Glue Catalog account id / catalog id for second ingest database"
    type = string
} 

variable "cdh_input2_database_name" {
    description = "Name of database with second ingest data"
    type = string
} 
